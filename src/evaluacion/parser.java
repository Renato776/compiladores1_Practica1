...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\010\000\006\002\uffff\006\004\001\002\000\004\004" +
    "\007\001\002\000\004\002\006\001\002\000\004\002\001" +
    "\001\002\000\004\005\010\001\002\000\004\007\011\001" +
    "\002\000\006\002\uffff\006\004\001\002\000\004\002\000" +
    "\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\001\001\000\004\002\011\001\001\000\002\001\001" });
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // INICIO ::= IDENTIFIER DOSPUNTOS STRINGLITERAL PUNTOCOMA INICIO 
            {
              Object RESULT =null;
		...
		String s = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 practica1.Practica1.evaluaciones.add(new practica1.Evaluacion(i,s)); 
